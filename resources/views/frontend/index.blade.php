            ...
            <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="parallax-wrapper">
                    <div class="parallax-img scrollblock" id="parallax-head">
                        <img src="{{asset('assets/images/large-chips-1.png')}}" alt="" class="chip1" data-aos="fade-down" data-aos-duration="1000" data-aos-delay="3s">
                        <img src="{{asset('assets/images/small-ships-blur.png')}}" alt="" class="chip2">
                        <img src="{{asset('assets/images/burger.png')}}" alt="" class="burger" data-aos="zoom-in-left" data-aos-duration="2000">
                        <img src="{{asset('assets/images/wyn-glass.png')}}" alt="" class="mug" data-aos="fade-left" data-aos-duration="2000" data-aos-delay="4s">
                        <img src="{{asset('assets/images/small-ships-blur.png')}}" alt="" class="chip5" data-aos="zoom-in-left" data-aos-duration="1500">
                        <img src="{{asset('assets/images/small-ships.png')}}" alt="" class="chip3" data-aos="zoom-out-right" data-aos-duration="1500">
    ...
    <div class="container">
        <div class="row">
            <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                <img src="{{asset('assets/images/about-img.png')}}" alt="" data-aos="zoom-in" class="img-fluid">
            </div>
            <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
